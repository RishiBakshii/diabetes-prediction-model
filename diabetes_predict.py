...
def app(diabetes_df):
    ...
    bmi=st.slider('BMI',int(diabetes_df['BMI'].min()),int(diabetes_df['BMI'].max()))
    
    pedigree=st.slider('Pedigree',int(diabetes_df['Pedigree_Function'].min()),int(diabetes_df['Pedigree_Function'].max()))
